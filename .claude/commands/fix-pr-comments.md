---
allowed-tools: Bash(gh pr checkout:*), Bash(gh pr view:*), Bash(gh api:*), Bash(gh repo view:*), Bash(git diff:*), Bash(git log:*), Bash(git status:*), Bash(git branch:*), Bash(git stash:*), Bash(git checkout:*), Bash(git add:*), Bash(git commit:*), Bash(git push:*), Bash(git remote:*), Bash(npm test:*), Bash(npm run test:*), Bash(yarn test:*), Bash(yarn run test:*), Bash(pnpm test:*), Task, Read, Glob, Grep, Edit, Write, AskUserQuestion, TodoWrite
